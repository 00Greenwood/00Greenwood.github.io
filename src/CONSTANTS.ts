...
export const GITHUB_NAME = "@00Greenwood";
export const GITHUB_LINK = "https://github.com/00Greenwood";
export const LINKEDIN_NAME = "Marcus Greenwood";
export const LINKEDIN_LINK =
  "https://www.linkedin.com/in/marcus-greenwood-268663106/";
